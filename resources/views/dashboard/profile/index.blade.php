    ...
    <form action="{{route('profile.update')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row justify-content-between mb-3">
            <div class="col-6">
                ...
                <div class="mb-3">
                    <label for="_foto" class="form-label">Logo</label>
            ...
            <div class="col-6">
                ...
                <div class="mb-3">
                    <label for="_github" class="form-label">Username Lynk</label>
        ...
        <label for="_deskripsi" class="form-label">Short Description</label>
        <textarea class="form-control summernote" id="content" rows="5" name="_deskripsi">
            {!!get_meta_value('_deskripsi')!!}
        </textarea>
