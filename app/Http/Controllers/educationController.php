...
class educationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            [
                ...
                'info1.required' => 'Member Name cant be empty',
        ...
        return redirect()->route('education.index')->with('success', 'Add Data Team Successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('education.index')->with('success', 'Update Data Team Successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('education.index')->with('success', 'Delete Data Team Successfully!');
    }
}
