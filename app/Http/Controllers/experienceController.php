...
class experienceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            [
                ...
                'tittle.required' => 'Image Name cant be empty',
                'info1.required' => 'Project Name cant be empty',
                'tgl_mulai.required' => 'Start Date cant be empty',
                'content.required' => 'Description cant be empty',
            ]
        );
        ...
        return redirect()->route('experience.index')->with('success', 'Add Data Portofolio Successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('experience.index')->with('success', 'Update Data Portofolio Successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('experience.index')->with('success', 'Delete Data Portofolio Successfully!');
    }
}
